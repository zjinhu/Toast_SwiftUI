#
# Be sure to run `pod lib lint Toast_SwiftUI.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/jackiehu/Toast_SwiftUI'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'jackiehu' => '814030966@qq.com' }
  s.source           = { :git => 'https://github.com/jackiehu/Toast_SwiftUI.git', :tag => s.version.to_s }
